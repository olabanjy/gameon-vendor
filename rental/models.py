...
class RentalGame(models.Model):
    vendor = models.ForeignKey(
        "users.Profile",
        related_name="rental_game_vendor",
        null=True,
    ...
    displayImagePath = models.ImageField(
        upload_to="gameon/vendor/rental/games/displayImagePath/",
        default="default_display_pics.jpg",
        blank=True,
    )
    bannerImagePath = models.ImageField(
        upload_to="gameon/vendor/rental/games/bannerImagePath/",
        default="default_banner_pics.jpg",
        blank=True,
    )
    thumbnailImagePath = models.ImageField(
        upload_to="gameon/vendor/rental/games/thumbnailImagePath/",
